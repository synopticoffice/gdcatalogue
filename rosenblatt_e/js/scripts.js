	...
	*/
	...
	/**
			...
			function Particle() {
				...
				var possibleTexts = ["traces of", "POST", "ANTI", "the human", "NON", "spidering", "SEARCH", "HISTORIES"]
				var randomText = possibleTexts[Math.floor(Math.random()*possibleTexts.length)];
	
				this.character = randomText;
